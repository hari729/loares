...
def single_run(args):
    ...
    algorithm,function,n_vars,bounds,tf,psize,max_evals,selector,selection_pool,seed_id = args
...
def multi_objective_optimizer(function,n_vars,bounds,minmax,list_of_algos,list_of_psizes,
    ...
    for psize in list_of_psizes:
        ...
        for algo_name in list_of_algos:
            ...
            args = [(algorithm,function,n_vars,bounds,tf,psize,max_evals,selector,selection_pool,i) for i in seed_id]
