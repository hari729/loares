...
def e1(current_set,bounds):
    ...
    new = (current_set.population + 
                 r1  * (best_pop - current_set.population) -
...
def e2_bare(current_set,bounds):
    pop_size = current_set.population.shape[0]
    variables = current_set.population.shape[1]
...
def e3(current_set,bounds):
    ...
    # Compute BWR formula for all positions
    new = (current_set.population + 
                 r1  * (best_pop - worst_pop) +
                 r2  * (best_pop - current_set.population))
...
def e4(current_set,bounds):
    ...
    new = (current_set.population + 
                 r1  * (best_pop - mean) -
                 r2  * (worst_pop - current_set.population))
...
def e4_1_or_2(current_set,bounds):
    pop_size = current_set.population.shape[0]
    variables = current_set.population.shape[1]
...
def e4_1_to_2(current_set,bounds):
    pop_size = current_set.population.shape[0]
    variables = current_set.population.shape[1]
    ...
    r3 = np.random.rand(pop_size, 1)
    r4 = np.random.rand(pop_size, 1)
    T = np.random.uniform(1, 2, size=(pop_size,1))
...
def e4_n05_to_05(current_set,bounds):
    pop_size = current_set.population.shape[0]
    variables = current_set.population.shape[1]
    ...
    r3 = np.random.rand(pop_size, 1)
    r4 = np.random.rand(pop_size, 1)
    T = np.random.uniform(-0.5, 0.5, size=(pop_size,1))
...
def e4_n1_to_1(current_set,bounds):
    pop_size = current_set.population.shape[0]
    variables = current_set.population.shape[1]
    ...
    r3 = np.random.rand(pop_size, 1)
    r4 = np.random.rand(pop_size, 1)
    T = np.random.uniform(-1, 1, size=(pop_size,1))
...
def e2_1_to_2(current_set,bounds):
    pop_size = current_set.population.shape[0]
    variables = current_set.population.shape[1]
...
def e2_n05_to_05(current_set,bounds):
    pop_size = current_set.population.shape[0]
    variables = current_set.population.shape[1]
...
def e2_n1_to_1(current_set,bounds):
    pop_size = current_set.population.shape[0]
    variables = current_set.population.shape[1]
