...
get = {
    ...
    "zdt1": [zdt1, 30, benchmark_bounds("zdt1", 30), 2, 1, 40000, 100],
    "zdt2": [zdt2, 30, benchmark_bounds("zdt2", 30), 2, 1, 40000, 100],
    "zdt3": [zdt3, 30, benchmark_bounds("zdt3", 30), 2, 1, 40000, 100],
    "zdt4": [zdt4, 10, benchmark_bounds("zdt4", 10), 2, 1, 40000, 100],
    "zdt6": [zdt6, 10, benchmark_bounds("zdt6", 10), 2, 1, 40000, 100],
    "dtlz1": [dtlz1, 7, benchmark_bounds("dtlz1", 7), 3, 1, 40000, 100],
    "dtlz2": [dtlz2, 12, benchmark_bounds("dtlz2", 12), 3, 1, 40000, 100],
    "dtlz3": [dtlz3, 12, benchmark_bounds("dtlz3", 12), 3, 1, 40000, 100],
    "dtlz4": [dtlz4, 12, benchmark_bounds("dtlz4", 12), 3, 1, 40000, 100],
    "dtlz5": [dtlz5, 12, benchmark_bounds("dtlz5", 12), 3, 1, 40000, 100],
    "dtlz6": [dtlz6, 12, benchmark_bounds("dtlz6", 12), 3, 1, 40000, 100],
    "dtlz7": [dtlz7, 22, benchmark_bounds("dtlz7", 22), 3, 1, 40000, 100],
    "wfg1": [wfg1, 12, benchmark_bounds("wfg1", 12), 3, 1, 40000, 100],
    "wfg2": [wfg2, 12, benchmark_bounds("wfg2", 12), 3, 1, 40000, 100],
    "wfg3": [wfg3, 12, benchmark_bounds("wfg3", 12), 3, 1, 40000, 100],
    "wfg4": [wfg4, 12, benchmark_bounds("wfg4", 12), 3, 1, 40000, 100],
    "wfg5": [wfg5, 12, benchmark_bounds("wfg5", 12), 3, 1, 40000, 100],
    "wfg6": [wfg6, 12, benchmark_bounds("wfg6", 12), 3, 1, 40000, 100],
    "wfg7": [wfg7, 12, benchmark_bounds("wfg7", 12), 3, 1, 40000, 100],
    "wfg8": [wfg8, 12, benchmark_bounds("wfg8", 12), 3, 1, 40000, 100],
    "wfg9": [wfg9, 12, benchmark_bounds("wfg9", 12), 3, 1, 40000, 100],
}