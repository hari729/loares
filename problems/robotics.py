...
get = {
    ...
    "mau": [mau, 4, np.array([[24.5,45.5],[9,17],[60,110],[0,15]]),2,1,30000,100],
    ...
    "auv": [auv, 4, np.array([[0.148,0.223],[0.185,0.285],[1.5,4],[1.5,3]]),2,1,80000,200],
    "auv_g": [auv_gep_safe, 4, np.array([[0.148,0.223],[0.185,0.285],[1.5,4],[1.5,3]]),2,1,80000,200],
